...
HD_PWD='C:/Users/cansuge/Documents/FPGA/SPI/SPI_Serial/SPI_Serial.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log spi_to_serial.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_to_serial.tcl -notrace
