...
HD_PWD='C:/Users/cansuge/Documents/FPGA/SPI/SPI_Serial/SPI_Serial.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log spi_to_serial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_to_serial.tcl
