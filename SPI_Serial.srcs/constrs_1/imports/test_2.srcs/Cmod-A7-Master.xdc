...
create_clock -period 83.333 -waveform {0.000 41.667} [get_ports sysclk]
...
set_property IOSTANDARD LVCMOS33 [get_ports i_ser_rx]
set_property IOSTANDARD LVCMOS33 [get_ports o_ser_tx]
